...
echo '<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <p>Уважаемые пользователи системы! В системе произошло обновление. Для корректного отображения информации и работы с данными, пожалуйста, перезагрузите страницу, на которой работаете, с помощью комбинации Ctrl+F5, либо очистите кэш для сайта vtmo.by.</p>
