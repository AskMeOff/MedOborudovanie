...
echo '<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <p>Пожалуйста, убедитесь, что поле "Регистрационный номер оборудования" (Реестры УП «Центр экспертиз и испытаний в здравоохранении») заполнено. Это поле обязательно для сохранения записи. Напротив незаполненных полей Регистрационный номер оборудования стоит знак "!". Проверьте ваши записи!</p>
