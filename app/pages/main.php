...
echo '<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <p>Пожалуйста, убедитесь, что поле "Серийный номер" заполнено. Это поле обязательно для сохранения записи. Напротив незаполненных полей серийного номера стоит знак "!". Проверьте ваши записи!</p>
