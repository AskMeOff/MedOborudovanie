...
from oborudovanie o
    ...
    where ob.id_oblast = '.$id_oblast.' and o.serial_number is not null and t.id_type_oborudovanie in (2,4,11,12) and o.status in (0,1,3)';
...
from oborudovanie o
    ...
    left join uz uz on o.id_uz = uz.id_uz
    left join oblast ob on ob.id_oblast = uz.id_oblast
    where ob.id_oblast = '.$id_oblast.' and o.serial_number is null and t.id_type_oborudovanie in (2,4,11,12) and o.status in (0,1,3)';
    $resultobl_type = mysqli_query($connectionDB->con, $sql_type);
