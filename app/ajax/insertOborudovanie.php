...
$id_org = $_POST['id_org'];
$sql = "INSERT INTO oborudovanie (id_type_oborudovanie, date_create, date_postavki, date_release, model,serial_number, id_serviceman, date_last_TO, status, id_uz, id_from_reestr)
        VALUES ('$id_type_oborudovanie', $date_create, $date_postavki, $date_release, $model_prozvoditel,$serial_number, $service_organization, $date_last_TO, '$status', '$id_org', $id_from_reestr)";
